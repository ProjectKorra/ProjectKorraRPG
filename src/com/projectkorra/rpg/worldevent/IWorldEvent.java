...
public interface IWorldEvent {
	...
	/**
	 * A modifier for how the event affects the bending of it's element.
	 * <br>Scale: x = modifier
	 * <br>-- [0 < x < 1]: bending will be nerfed or cancelled entirely
	 * <br>-- [x > 1]: bending is empowered making most bending abilities stronger
	 * <br><b>The modifier should not be below 0 or insanely high, doing either 
	 * may have unintended consequences!
	 * @return numerical modifier for bending abilities of the WorldEvent's element
	 */
